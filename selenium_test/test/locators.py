...
class BasePageLocators(object):
    COURSE_BANNER = (By.XPATH, "//*[@id='bs-navbar-collapse']/ul[1]/li/a")
    HOME_LINK = (By.XPATH, "//*[@class='course-menu']/li[contains(@class='menu-home')]/a")
    CALENDAR_FEED_LINK = (By.XPATH, "//*[@class='calendar-view']/p/a[contains(@href, '/export-calendar/')]")
    RESULTS_LINK = (By.XPATH, "//*[@class='course-menu']/li[contains(@class='menu-results')]/a")
    USER_LINK = (By.XPATH, "//*[@class='course-menu']/li[contains(@class, 'menu-notifications')]/a")
    TEACHERS_VIEW_LINK = (By.XPATH, "//*[@class='course-menu']/li[contains(@class, 'menu-edit-course')]/a")
    LOGGED_USER_LINK = (By.XPATH, "//*[@id='user-menu']/li[contains(@class, 'menu-profile')]/a")
