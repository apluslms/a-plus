...
from selenium_test.page_objects.page_objects import LoginPage, MyFirstExerciseGrader, MyAjaxExerciseGrader, SubmissionPage, CourseName
...
class SubmissionsPageTest(unittest.TestCase):
    ...
    def testShouldContainAsManySubmissionsAsSubmitted(self):
        ...
        self.assertEqual(SubmissionPage(self.driver, 1).getSubmissionCount(), 1)

        firstExercisePage = MyFirstExerciseGrader(self.driver)
        firstExercisePage.setText("Hello")
        firstExercisePage.submit()
        self.assertEqual(SubmissionPage(self.driver, 1).getSubmissionCount(), 2)

        ajaxExercisePage = MyAjaxExerciseGrader(self.driver)
        ajaxExercisePage.setText(-1)
        ajaxExercisePage.submit()
        self.assertEqual(SubmissionPage(self.driver, 3).getSubmissionCount(), 1)

        ajaxExercisePage = MyAjaxExerciseGrader(self.driver)
        ajaxExercisePage.setText(50)
        ajaxExercisePage.submit()
        self.assertEqual(SubmissionPage(self.driver, 3).getSubmissionCount(), 2)

        firstExercisePage = MyFirstExerciseGrader(self.driver)
        firstExercisePage.setText("HelloA+")
        firstExercisePage.submit()
        self.assertEqual(SubmissionPage(self.driver, 1).getSubmissionCount(), 3)

        ajaxExercisePage = MyAjaxExerciseGrader(self.driver)
        ajaxExercisePage.setText(100)
        ajaxExercisePage.submit()
        self.assertEqual(SubmissionPage(self.driver, 3).getSubmissionCount(), 3)
