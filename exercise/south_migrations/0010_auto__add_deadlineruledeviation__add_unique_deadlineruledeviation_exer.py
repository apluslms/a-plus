...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeadlineRuleDeviation'
        db.create_table('exercise_deadlineruledeviation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exercise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercise.BaseExercise'])),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.UserProfile'])),
            ('extra_minutes', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('exercise', ['DeadlineRuleDeviation'])

        # Adding unique constraint on 'DeadlineRuleDeviation', fields ['exercise', 'submitter']
        db.create_unique('exercise_deadlineruledeviation', ['exercise_id', 'submitter_id'])

        # Adding model 'MaxSubmissionsRuleDeviation'
        db.create_table('exercise_maxsubmissionsruledeviation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exercise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercise.BaseExercise'])),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.UserProfile'])),
            ('extra_submissions', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('exercise', ['MaxSubmissionsRuleDeviation'])

        # Adding unique constraint on 'MaxSubmissionsRuleDeviation', fields ['exercise', 'submitter']
        db.create_unique('exercise_maxsubmissionsruledeviation', ['exercise_id', 'submitter_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MaxSubmissionsRuleDeviation', fields ['exercise', 'submitter']
        db.delete_unique('exercise_maxsubmissionsruledeviation', ['exercise_id', 'submitter_id'])

        # Removing unique constraint on 'DeadlineRuleDeviation', fields ['exercise', 'submitter']
        db.delete_unique('exercise_deadlineruledeviation', ['exercise_id', 'submitter_id'])

        # Deleting model 'DeadlineRuleDeviation'
        db.delete_table('exercise_deadlineruledeviation')

        # Deleting model 'MaxSubmissionsRuleDeviation'
        db.delete_table('exercise_maxsubmissionsruledeviation')
    ...
    models = {
        ...
        'exercise.deadlineruledeviation': {
            ...
            'exercise': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exercise.BaseExercise']"}),
        ...
        'exercise.submission': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'OXSZMthpZDUk9dmurqjt5xPCxOlUz6Jh'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
