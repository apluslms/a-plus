...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmittedFile.file_object'
        db.alter_column('exercise_submittedfile', 'file_object', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'SubmittedFile.file_object'
        db.alter_column('exercise_submittedfile', 'file_object', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'exercise.submission': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'5B7hlbiadiFbgahuCE10m824JA9cfTSF'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'exercise.submittedfile': {
            ...
            'file_object': ('django.db.models.fields.files.FileField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
