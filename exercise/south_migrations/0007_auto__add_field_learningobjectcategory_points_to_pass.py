...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearningObjectCategory.points_to_pass'
        db.add_column('exercise_learningobjectcategory', 'points_to_pass',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearningObjectCategory.points_to_pass'
        db.delete_column('exercise_learningobjectcategory', 'points_to_pass')
    ...
    models = {
        ...
        'exercise.submission': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'GGkh9d17bc42T8IA0tGfLQwojp2aU9iR'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
