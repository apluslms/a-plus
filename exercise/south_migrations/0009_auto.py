...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field hidden_to on 'LearningObjectCategory'
        db.create_table('exercise_learningobjectcategory_hidden_to', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('learningobjectcategory', models.ForeignKey(orm['exercise.learningobjectcategory'], null=False)),
            ('userprofile', models.ForeignKey(orm['userprofile.userprofile'], null=False))
        ))
        db.create_unique('exercise_learningobjectcategory_hidden_to', ['learningobjectcategory_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field hidden_to on 'LearningObjectCategory'
        db.delete_table('exercise_learningobjectcategory_hidden_to')
    ...
    models = {
        ...
        'exercise.submission': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'Ph1d7y3KKjw0Kh9Wwe1M9AAs418fALj1'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
