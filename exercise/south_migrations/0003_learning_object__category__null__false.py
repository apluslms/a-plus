...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for inst in orm['course.CourseInstance'].objects.all():
            # Create one LearningObjectCatecory for each CourseInstance
            cat = orm.LearningObjectCategory(name="Exercises", course_instance=inst)
            cat.save()
            for module in inst.course_modules.all():
                for obj in module.learning_objects.all():
                    obj.category = cat
                    obj.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for obj in orm.LearningObject.objects.all():
            obj.category = None
            obj.save()
        for cat in orm.LearningObjectCategory.objects.all():
            cat.delete()
    ...
    models = {
        ...
        'exercise.submission': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'mv1fzplUKmyPSK5PnUD6QX59abVeZvM0'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
