...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LearningObject.name'
        db.alter_column('exercise_learningobject', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'LearningObject.name'
        db.alter_column('exercise_learningobject', 'name', self.gf('django.db.models.fields.CharField')(max_length=35))
    ...
    models = {
        ...
        'exercise.submission': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'brK4m4IdJiUqw3tGj36crSTV8PPBozT6'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
