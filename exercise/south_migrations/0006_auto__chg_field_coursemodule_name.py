...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseModule.name'
        db.alter_column('exercise_coursemodule', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'CourseModule.name'
        db.alter_column('exercise_coursemodule', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'exercise.submission': {
            ...
            'hash': ('django.db.models.fields.CharField', [], {'default': "'BlpO3NFKYVOqgPagdii7htTcD7KP0aKc'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
