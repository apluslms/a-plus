...
class CourseChapterAdmin(admin.ModelAdmin):
    search_fields = ["name", "category__name", "course_module__name",
...
class SubmissionAdmin(admin.ModelAdmin):
    search_fields = ["exercise__name", "submitters__student_id",
        "submitters__user__username", "submitters__user__first_name",
    ...
    list_filter = ["status", "grade", "submission_time",
    ...
    search_fields = ["id", "exercise__name",
                     ...
                     "submitters__user__last_name", "submitters__user__email"]
    list_per_page = 500
    raw_id_fields = ["submitters", "grader"]
...
class SubmittedFileAdmin(admin.ModelAdmin):
    search_fields = ["submission__exercise__name",
