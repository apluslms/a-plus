...
urlpatterns = [
    ...
    url(EXERCISE_URL_PREFIX + r'submissions/regrade/$',
        staff_views.RegradeView.as_view(),
        name="submission-regrade"),
    ...
    url(EXERCISE_URL_PREFIX + r'submitters/$',
        staff_views.ListSubmittersView.as_view(),
        name="submitter-list"),
    url(EXERCISE_URL_PREFIX + r'submitters/(?P<user_id>\d+)/$',
    ...
    url(EXERCISE_URL_PREFIX + r'info/$',
        ...
        name="exercise-info"),
    url(EXERCISE_URL_PREFIX + r'draft/$',
