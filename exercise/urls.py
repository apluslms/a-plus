...
urlpatterns = [
    ...
    re_path(SUBMISSION_URL_PREFIX + r'invalidate/$',
        staff_views.SubmissionInvalidateView.as_view(),
        name="submission-invalidate"),
    re_path(SUBMISSION_URL_PREFIX + r'revalidate/$',
        staff_views.SubmissionRevalidateView.as_view(),
        name="submission-revalidate"),
