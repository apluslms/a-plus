...
from exercise.staff_views import list_exercise_submissions, inspect_exercise_submission, \
    add_or_edit_exercise, fetch_exercise_metadata, submission_assessment, re_submit_to_service
...
urlpatterns = patterns('',
    ...
    (r'^submissions/re-submit-to-service/(?P<submission_id>\d+)/$', re_submit_to_service),
)