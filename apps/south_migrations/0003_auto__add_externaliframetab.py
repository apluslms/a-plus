...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalIFrameTab'
        db.create_table('apps_externaliframetab', (
            ('basetab_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['apps.BaseTab'], unique=True, primary_key=True)),
            ('content_url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('width', self.gf('django.db.models.fields.IntegerField')()),
            ('height', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('apps', ['ExternalIFrameTab'])


    def backwards(self, orm):
        # Deleting model 'ExternalIFrameTab'
        db.delete_table('apps_externaliframetab')
