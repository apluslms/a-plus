...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IFrameToServicePlugin'
        db.create_table('apps_iframetoserviceplugin', (
            ('baseplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['apps.BasePlugin'], unique=True, primary_key=True)),
            ('service_url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('width', self.gf('django.db.models.fields.IntegerField')()),
            ('height', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('apps', ['IFrameToServicePlugin'])

        # Adding field 'BasePlugin.views'
        db.add_column('apps_baseplugin', 'views',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'IFrameToServicePlugin'
        db.delete_table('apps_iframetoserviceplugin')

        # Deleting field 'BasePlugin.views'
        db.delete_column('apps_baseplugin', 'views')
    ...
    models = {
        ...
        'apps.iframetoserviceplugin': {
            'Meta': {'object_name': 'IFrameToServicePlugin', '_ormbases': ['apps.BasePlugin']},
            'baseplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['apps.BasePlugin']", 'unique': 'True', 'primary_key': 'True'}),
