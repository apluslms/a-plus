...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('course_courseinstance', 'website', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'CourseInstance.url'
        db.alter_column('course_courseinstance', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'CourseInstance.instance_name'
        db.alter_column('course_courseinstance', 'instance_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Course.url'
        db.alter_column('course_course', 'url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Course.code'
        db.alter_column('course_course', 'code', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Course.name'
        db.alter_column('course_course', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CourseInstance.url'
        db.alter_column('course_courseinstance', 'url', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'CourseInstance.instance_name'
        db.alter_column('course_courseinstance', 'instance_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Course.url'
        db.alter_column('course_course', 'url', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True))

        # Changing field 'Course.code'
        db.alter_column('course_course', 'code', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Course.name'
        db.alter_column('course_course', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
