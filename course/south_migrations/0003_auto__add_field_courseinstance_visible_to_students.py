...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseInstance.visible_to_students'
        db.add_column('course_courseinstance', 'visible_to_students',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseInstance.visible_to_students'
        db.delete_column('course_courseinstance', 'visible_to_students')
