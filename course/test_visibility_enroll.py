...
class CourseVisibilityTest(TestCase):
    ...
    def test_course_home(self):
        ...
        # not in the enrollment audience
        ext_regist_instance = CourseInstance.objects.create( # pylint: disable=unused-variable
    ...
    def test_chapter_enrolled_only(self):
        ...
        # chapter exercise
        chapter_exercise = self.learning_objects[self.enrolled_course_instance.id][1] # pylint: disable=unused-variable
    ...
    def test_chapter_public(self):
        ...
        # chapter exercise
        chapter_exercise = self.learning_objects[self.public_course_instance.id][1] # pylint: disable=unused-variable
