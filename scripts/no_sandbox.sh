...
if [ $# -lt 6 ]; then
    ...
    echo "    1k for kilobyte, 1m for megabyte and - for unlimited"
...
#TODO: should add the course argument for another path
export PATH="/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:$ROOT/scripts/sandbox"
